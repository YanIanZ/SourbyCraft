...
class MetricsApiSurfaceTest {
    ...
    void methodDescriptorsArePinnedBeforeInitialRelease() {
        final Map<Class<?>, Map<String, String>> expected = Map.of(
            ...
            RuntimeMetrics.class, Map.ofEntries(
                Map.entry("heapUsedBytes", "()long"),
                Map.entry("heapMaxBytes", "()long"),
                Map.entry("rssPercent", "()double"),
                Map.entry("gcTimePercent", "()double"),
                Map.entry("gcCollectionsPerMinute", "()double"),
                Map.entry("averageGcPauseMs", "()double"),
                Map.entry("heapCommittedBytes", "()long"),
                Map.entry("nonHeapUsedBytes", "()long"),
                Map.entry("processRssBytes", "()long"),
                Map.entry("processCpuPercent", "()double"),
                Map.entry("systemCpuPercent", "()double"),
                Map.entry("availableProcessors", "()int"),
                Map.entry("liveThreadCount", "()int"),
                Map.entry("uptimeMillis", "()long"),
                Map.entry("gcCollectionTimeMillis", "()long"),
                Map.entry("gcCollectionCount", "()long")),
