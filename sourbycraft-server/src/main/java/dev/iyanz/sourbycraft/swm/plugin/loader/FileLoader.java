...
public class FileLoader implements SlimeLoader {
    ...
    public FileLoader(Path baseDir) {
    ...
    public byte[] readWorld(String name) throws IOException {
        ...
        if (!Files.exists(file)) throw new FileNotFoundException(name + ".slime");
        return Files.readAllBytes(file);
    }

    @Override
    public void writeWorld(String name, byte[] data) throws IOException {
