...
import dev.iyanz.sourbycraft.swm.loader.UpdatableLoader;
...
public class MongoLoader extends UpdatableLoader {
    ...
    public MongoLoader(String database, String collection, String username, String password,
                        String authSource, String host, Integer port, String uri) throws MongoException {
    ...
    @Override
    public void deleteWorld(String worldName) throws IOException, IOException {
        try {
            MongoDatabase mongoDatabase = client.getDatabase(database);
            GridFSBucket bucket = GridFSBuckets.create(mongoDatabase, collection);
